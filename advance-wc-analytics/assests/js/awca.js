/**
 * Purpose: Handles different ajax requests required for removing and deleting plugin access and 
 * also store last tab user used in the plugin along with other plugin settings changes.
 */
